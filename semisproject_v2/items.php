...
<head>
    ...
    <style>
		...
		.edit-form {
		 ...
		 input[type="submit"] {
            padding: 5px; /* Increase the button's padding */
            width: 40%; /* Set button width to 10% */
...
<body style="margin: 0;">
    ...
    <form method="post" action="">
        ...
        <input type="textinfo" name="isbn" placeholder="ISBN:">
        <input type="textinfo" name="title" placeholder="Title:">
        <input type="textinfo" name="author" placeholder="Author:">
		<input type="textinfo" name="genre" placeholder="Genre:">
		<input type="textinfo" name="booktype" placeholder="Booktype:">
        <input type="textinfo" name="price" placeholder="Price:">
